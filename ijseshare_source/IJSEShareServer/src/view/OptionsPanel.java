...
//                   txtIp.setText(p);
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "error reading config file!", "error", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
    }
    ...
    private void writeConfigFile() {
        ...
        if (!txtPort.getText().trim().equals(port)) {
            port = txtPort.getText();

//        if (!txtIp.getText().trim().equals(ip)) {
//            ip = txtIP.getText();
//        }
            try {
                File file = new File(path + "ijseshare.config");
